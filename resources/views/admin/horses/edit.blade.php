        ...
        <form method="POST" action="{{ route('admin.horses.update', $horse) }}" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                          class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-emerald-500">{{ old('description', $horse->description) }}</textarea>
            </div>
            ...
            <div class="flex gap-3 pt-4">
                <button type="submit" class="px-6 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition font-medium">Update Horse</button>
