...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    {{-- Navigation --}}
    <nav class="bg-white/40 dark:bg-gray-800/40 backdrop-blur-xl border-b border-white/30 dark:border-gray-700/50 sticky top-0 z-50 shadow-sm shadow-emerald-900/5">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-8">
                    ...
                    <div class="hidden sm:flex space-x-1">
                        <a href="{{ route('home') }}" class="px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('home') ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300' : 'text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700' }} transition">
                            Home
                        </a>
                        <a href="{{ route('products.index') }}" class="px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('products.*') ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300' : 'text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700' }} transition">
                            Horses
                        </a>
                    </div>
                </div>
                <div class="flex items-center space-x-3">
                    @auth
                        <a href="{{ route('cart.index') }}" class="relative p-2 text-gray-600 hover:text-emerald-600 dark:text-gray-300 dark:hover:text-emerald-400 transition">
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg transition shadow-sm">Register</a>
                    @endauth
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <li><a href="{{ route('products.index') }}" class="hover:text-emerald-600 dark:hover:text-emerald-400">Browse Horses</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                        @auth
                            <li><a href="{{ route('member.index') }}" class="hover:text-emerald-600 dark:hover:text-emerald-400">My Account</a></li>
                            <li><a href="{{ route('cart.index') }}" class="hover:text-emerald-600 dark:hover:text-emerald-400">Cart</a></li>
                        @else
                            <li><a href="{{ route('login') }}" class="hover:text-emerald-600 dark:hover:text-emerald-400">Login</a></li>
                            <li><a href="{{ route('register') }}" class="hover:text-emerald-600 dark:hover:text-emerald-400">Register</a></li>
                        @endauth
                    </ul>
                </div>
            </div>
